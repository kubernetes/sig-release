...
- Implement normalize plugin extension point for the scheduler framework.
  ...
  Courtesy of SIG API Machinery, SIG Apps, SIG Architecture, SIG Auth, SIG Autoscaling, SIG CLI, SIG Cloud Provider, SIG Cluster Lifecycle, SIG GCP, SIG Instrumentation, SIG Network, SIG Node, SIG Release, SIG Scheduling, SIG Storage, and SIG Testing
...
### SIG API Machinery, SIG Cluster Lifecycle, and SIG GCP
...
- No ([#80805](https://github.com/kubernetes/kubernetes/pull/80805), [@mgdevstack](https://github.com/mgdevstack))
