...
* kube-scheduler now has the `--write-config-to` flag so that Scheduler canwrite its default configuration to a file.
...
* Basic plumbing for volume topology aware dynamic provisioning has been implemented. ([#63232](https://github.com/kubernetes/kubernetes/pull/63232), [@lichuqiang](https://github.com/lichuqiang))
...
* Included kms-plugin-container.manifest to master manifests tarball. ([#65035](https://github.com/kubernetes/kubernetes/pull/65035), [@immutableT](https://github.com/immutableT))
