...
- Fixed spurious `field is immutable` errors validating updates to Event API ([#112183](https://github.com/kubernetes/kubernetes/pull/112183), [@liggitt](https://github.com/liggitt))
