...
- [sig-network] DNS should resolve hostname and hostNetwork for a Pod [Conformance] [sig-network, Conformance]
  ...
  5hqm -- /bin/sh -x -c hostname'
    ...
    STEP: Destroying namespace "dns-319" for this suite. @ 04/21/24 07:33:35.225     • [2.247 seconds] ([#124428](https://github.com/kubernetes/kubernetes/pull/124428), [@yashsingh74](https://github.com/yashsingh74)) [SIG Architecture, Network and Testing]
