...
- Fixed incorrect "v1 Binding is deprecated in v1.6+" warning in kube-scheduler ([#125540](https://github.com/kubernetes/kubernetes/pull/125540), [@pohly](https://github.com/pohly))
...
- ```
  ...
  - [KEP]: <link>
  - [Usage]: <link>
  - [Other doc]: <link> ([#124160](https://github.com/kubernetes/kubernetes/pull/124160), [@Karthik-K-N](https://github.com/Karthik-K-N))
