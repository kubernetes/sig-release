...
- Kube-proxy's nftables mode is now beta and available by default. It
  ...
  size will be slower with nftables mode than with iptables mode.) ([#124383](https://github.com/kubernetes/kubernetes/pull/124383), [@danwinship](https://github.com/danwinship)) [SIG Cloud Provider and Network]
