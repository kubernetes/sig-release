...
- We don’t require people to work on nights and weekends. However, if they’re the times you want to dedicate to the project, feel free to do so. It's also important to note that for some contributors the weekend starts on a Thursday, and that meetings scheduled on Friday are an inconvienience.
